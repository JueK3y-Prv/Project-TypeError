...
if (theme) {
    ...
    window.addEventListener("load", function () {
        window.wpcc.init({
            ...
            content: { message: "Für ein besseres Erlebnis verwenden wir Cookies auf unserer Webseite.", link: "Klicke hier für mehr Informationen", button: "Okay, verstanden", href: "#" },
            position: "bottom",
            margin: "none",
            padding: "none",
            border: "thin",
    ...
    window.addEventListener("load", function () {
        window.wpcc.init({
            ...
            content: { message: "Für ein besseres Erlebnis verwenden wir Cookies auf unserer Webseite.", link: "Klicke hier für mehr Informationen", href: "#", target: "_blank", button: "Okay, verstanden"},
            position: "bottom",
            margin: "none",
            padding: "none",
            border: "thin",
