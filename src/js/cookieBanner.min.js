...
if (theme.hasAttribute("light"))  {
    ...
    window.addEventListener("load", function(){window.wpcc.init({"corners":"small","colors":{"popup":{"background":"#1B1C1E","text":"#FAFAFA","border":"#e0e0e0"},"button":{"background":"#283d62","text":"#fafafa"}},"content":{"message":"Für ein besseres Erlebnis verwenden wir Cookies auf unserer Webseite.","link":"Klicke hier für mehr Informationen","button":"Okay, verstanden","href":"#"},"position":"bottom","margin":"none","padding":"none","border":"thin","fontsize":"small"})});
}
    ...
    window.addEventListener("load", function(){window.wpcc.init({"corners":"small","colors":{"popup":{"background":"#ffffff","text":"#82888c","border":"#e0e0e0"},"button":{"background":"#0341b5c2","text":"#fafafa"}},"content":{"message":"Für ein besseres Erlebnis verwenden wir Cookies auf unserer Webseite.","link":"Klicke hier für mehr Informationen","button":"Okay, verstanden","href":"#"},"position":"bottom","margin":"none","padding":"none","border":"thin","fontsize":"small"})});
}